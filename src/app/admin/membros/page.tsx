...
export default async function AdminMembersPage() {
  ...
  return (
    <AdminSubpage
      ...
      description="Configure o canal oficial e acompanhe o status dos membros."
    >
      <section className="grid gap-6 lg:grid-cols-[420px_1fr]">
        <Card className="p-5">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold">Canal WhatsApp</h2>
          </div>
          <form action={updateWhatsappLink} className="mt-5 grid gap-4" data-testid="whatsapp-settings-form">
            <Field label="Link do canal" name="whatsapp_group_url" defaultValue={whatsappLink} required />
